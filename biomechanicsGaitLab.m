...
%subject throughout his stance phase using motion capture data and a force 
%plate. These claculations are made for three sets of movement data: when 
...
%% Linear Velocity/Acceletation for Fast Walk(m/s and m/s^2)
...
%% Linear Velocity/Acceletation for Jog(m/s and m/s^2)
